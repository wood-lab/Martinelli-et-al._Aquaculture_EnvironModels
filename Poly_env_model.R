...
### Carr Inlet
###########################################################
setwd('/Users/jmartine/Desktop/buoys/Carr Inlet/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

carr <- ldply(env.files, read_csv) # read all the files 
...
### Cherry Point
###########################################################
setwd('/Users/jmartine/Desktop/buoys/cherry point/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

cherry <- ldply(env.files, read_csv, show_col_types = FALSE) # read all the files 
...
### Hoodsport
###########################################################
setwd('/Users/jmartine/Desktop/buoys/Hoodsport/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

hoodsport <- ldply(env.files, read_csv, show_col_types = FALSE) # read all the files 
...
### Port Townsend
###########################################################
setwd('/Users/jmartine/Desktop/buoys/port townsend/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

ptownsend <- ldply(env.files, read_csv, show_col_types = FALSE) # read all the files 
...
### Tokeland
###########################################################
setwd('/Users/jmartine/Desktop/buoys/tokeland/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

tokeland <- ldply(env.files, read_csv) # read all the files 
...
### Bayview
###########################################################
setwd('/Users/jmartine/Desktop/buoys/Bayview channel/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

bayview <- ldply(env.files, read_csv, show_col_types = FALSE) # read all the files 
...
### COOS BAY BUOY
###########################################################
setwd('/Users/jmartine/Desktop/buoys/Coos Bay buoy/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

coos <- ldply(env.files, read_csv, show_col_types = FALSE) # read all the files 
...
### BODEGA BAY BUOY
###########################################################
setwd('/Users/jmartine/Desktop/buoys/bodega bay/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay
...
### yaquina BAY BUOY
###########################################################
setwd('/Users/jmartine/Desktop/buoys/yaquina/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

yaquina <- ldply(env.files, read_csv) # read all the files 
...
###########################################################
setwd('/Users/jmartine/Desktop/buoys/netarts bay/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

netarts <- ldply(env.files, read_csv, show_col_types = FALSE) # read all the files 
...
### ketchikan BAY BUOY
###########################################################
setwd('/Users/jmartine/Desktop/buoys/Ketchikan/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

ketchikan <- ldply(env.files, read_csv) # read all the files 
...
### tillamook BAY BUOY
###########################################################
setwd('/Users/jmartine/Desktop/buoys/tillamook/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

tillamook <- ldply(env.files, read_csv) # read all the files 
...
### tomales BAY BUOY
###########################################################
setwd('/Users/jmartine/Desktop/buoys/tomales/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay
...
### humboldt BAY BUOY
###########################################################
setwd('/Users/jmartine/Desktop/buoys/humboldt/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay
...
### homer BAY BUOY
###########################################################
setwd('/Users/jmartine/Desktop/buoys/Homer surface/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

homer <- ldply(env.files, read_csv, show_col_types = FALSE) # read all the files 
...
### PT ALEXANDER BUOY
###########################################################
setwd('/Users/jmartine/Desktop/buoys/port alexander/')
mydir <- 'CSVs'
env.files <- list.files(path=mydir, pattern="*.csv", full.names=TRUE)
env.files # check the list of files is okay

portalex <- ldply(env.files, read_csv,show_col_types = FALSE) # read all the files 
...
prev <- read.csv('master_spreadsheet_all.csv', header=TRUE, row.names = NULL, stringsAsFactors=FALSE,  sep=',') # na.strings=c('NA','\\N')
